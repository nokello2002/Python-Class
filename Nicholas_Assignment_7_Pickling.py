# -*- coding: utf-8 -*-
"""
Created on Fri Apr 30 11:59:39 2021
...
def phone_book():
    ...
    while True:
        ...
        if operation =='1':       #List contacts
            filename="D:\PythonLessons\contacts_pickle"
            infile=open(filename, "rb")
            my_contacts=pickle.load(infile)
            infile.close()
            #print(my_contacts)
            ...
            while str_action=="y":
                ...
                pickle.dump(my_contacts, outfile)
                outfile.close()
            ...
            my_contacts={}
            my_contacts=pickle.load(outfile)
